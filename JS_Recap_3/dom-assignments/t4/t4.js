...
navigator.geolocation.getCurrentPosition(
  position => {
    ...
    console.log('Sorted restaurants:', restaurants.slice(0, 5));
    restaurants.forEach(r => {
  ...
  () => {
    const row = document.createElement('tr');
    row.innerHTML = `<td colspan="2">Unable to get your location.</td>`;
    tbody.appendChild(row);
  }
);
console.log('Requested geolocation… waiting for callback');

setTimeout(() => {
  console.log('If you see this, geolocation never responded.');
}, 3000);
